        ...
        if(alertType == 'func'){
            return( 
                <div className={`center fixed top-0 w-full h-screen z-100`} style={{
                    ...
                    <div className={`w-11/12 md:w-6/12 xl:w-4/12  min-h-64 bg-gray-50 shadow-xl rounded-2xl center flex-col gap-7 py-4 px-9 alert text-center`}>        
                        <h3 className="text-lg">{alertMessage[0]?.toUpperCase()}</h3>

                        <div className="flex justify-between w-full gap-5">
                            <button className={`bg-blue w-5/12 rounded-lg p-3 text-gray-200 shadow-xl`} onClick={() => logout()}>YES</button>


                            <button className={`border border-gray-900 bg-gray-100 shadow-xl w-5/12 rounded-lg p-3 text-gray-900`} onClick={() => setShowAlert(false)}>NO</button>
            ...
            return( 
                <div className={`center fixed top-0 w-full h-screen z-100`} style={{
                    ...
                    <div className={`w-9/12 md:w-9/12 xl:w-6/12  min-h-64 bg-gray-50 shadow-xl rounded-3xl center flex-col gap-4 py-7 px-6 alert text-center`}>
                        ...
                        <button className={`bg-gray-900 w-6/12 rounded-lg p-3 mt-5 text-gray-200`} onClick={() => setShowAlert(false)}>CLOSE</button>
                    </div>
                </div>
            )
