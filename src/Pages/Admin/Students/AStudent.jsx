    ...
    return(
        <>
            ...
            <div className="center mt-9 pt-9">
                <div className="flex justify- flex-col w-11/12 gap-5">
                    ...
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                        ...
                        <h1 className="text-sm p-1">{student.firstName}  {student?.middleName?.toUpperCase()} {student.lastName} </h1>
                    </div>
                    <div className="flex flex-col">
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                        ...
                        <h1 className="text-sm p-1">{student.registrationNumber}</h1>
                    </div>
                    <div className="flex flex-col">
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                        ...
                        <h1 className="text-sm p-1">{student?.training}</h1>
                    </div>
                    <div className="flex flex-col">
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                        ...
                        <h1 className="text-sm p-1">{student?.email}</h1>
                    </div>
                    <div className="flex flex-col">
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                        ...
                        <h1 className="text-sm p-1">{student?.testScore}</h1>
                    </div>
                    <div className="flex flex-col">
                    <h3 className="text-sm bg-gray-100 flex rounded overflow-hidden">
                            <i className="bi bi-percent mr-3 bg-gray-900 text-gray-200 p-1 px-2"></i>
                        ...
                        <h1 className="text-sm p-1">{student?.examScore}</h1>
                    </div>
