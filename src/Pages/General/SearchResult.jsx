...
export const SearchResult = ({student, certificate, images}) => {
    ...
    return(
        <div className="center w-full flex-col p-3 gap-4 mb-9">
            { !loadingCertificate ?
